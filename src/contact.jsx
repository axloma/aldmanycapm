    ...
    <>
        ...
        <section  className="contact_area section_gap">
            <div  className="container">
                ...
                <div style={{width: "100%"}}>
                    <iframe width="100%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=1%20Grafton%20Street,%20Dublin,%20Ireland+(aldamanyCamp)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed">
                    ...
                    <div  className="col-md-3">
                        <div  className="contact_info">
                            ...
                            <div  className="info_item">
                                ...
                                <h6><a href="#">{phone || "phone"}</a></h6>
                                <p>{Businesshours || "Working Hours"}"</p>
                            </div>
                            <div  className="info_item">
                                <i  className="lnr lnr-envelope"></i>
                                <h6><a href="#">{supportemail || "supportemail"}</a></h6>
